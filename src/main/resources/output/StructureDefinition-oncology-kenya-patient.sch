...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'https://oncology.ig.kenya/StructureDefinition/patient-educationLevel']) &lt;= 1">extension with URL = 'https://oncology.ig.kenya/StructureDefinition/patient-educationLevel': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://oncology.ig.kenya/StructureDefinition/patient-occupation']) &lt;= 1">extension with URL = 'https://oncology.ig.kenya/StructureDefinition/patient-occupation': maximum cardinality of 'extension' is 1</sch:assert>
