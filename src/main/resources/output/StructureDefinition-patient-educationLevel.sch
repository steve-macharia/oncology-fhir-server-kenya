...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      ...
      <sch:assert test="count(f:extension[@url = 'dataSource']) &lt;= 1">extension with URL = 'dataSource': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'verifiedBy']) &lt;= 1">extension with URL = 'verifiedBy': maximum cardinality of 'extension' is 1</sch:assert>
