...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Practitioner">
      <sch:assert test="count(f:extension[@url = 'http://example.org/StructureDefinition/practitioner-work-county']) &lt;= 1">extension with URL = 'http://example.org/StructureDefinition/practitioner-work-county': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://example.org/StructureDefinition/practitioner-cadre-code']) &lt;= 1">extension with URL = 'http://example.org/StructureDefinition/practitioner-cadre-code': maximum cardinality of 'extension' is 1</sch:assert>
